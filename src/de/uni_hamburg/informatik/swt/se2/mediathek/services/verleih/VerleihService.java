...
public interface VerleihService extends ObservableService
{
    ...
    /**
     * Prüft ob der Kunde die ausgewählten Medien vormerken kann.
     * 
     * @param medien Die medien
     * @param kunde Der Kunde für den geprüft werden soll 
     * 
	...
	/**
     * Merkt Medien an einen Kunden vor. Dabei wird für jedes Medium eine neue
     ...
     * @require kundeImBestand(kunde)
     * 
     * @ensure sindAlleVorgemerktAn(kunde, medien)
     */
	void vormerkenAn(List<Medium> medien, Kunde kunde);
	...
	/**
     * Prüft, ob Medien an einen bestimmten Kunden vorgemerkt sind.
     * 
     * 
     * @param medien Medium
     * @param kunde Ein Kunde
     * @return true, wenn die Medien an den Kunden vorgemerkt sind, sonst false.
     * 
     * @require kundeImBestand(kunde)
     * @require mediumImBestand(medium)
     */
	boolean istKundeInVormerkliste(List<Medium> medien, Kunde kunde);
